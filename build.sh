...
export v030=v0.30.1 v029=v0.29.5 v028=v0.28.10 v027=v0.27.14 v026=v0.26.15 v025=v0.25.16 v024=v0.24.17
k8s_api_v02=$(
...
code_reset
{
  ...
  go mod edit -replace "github.com/containers/image/v5=github.com/containers/image/v5@v5.30.1" go.mod
  go get -u all
